import logo from '../../../assets/images/diy-logo.png';
import imageHero from './hero.jpg';
import imageJennyWilson from './jenny-wilson.jpg';

export const caseStudy = {
  client: 'Diy Divorce Solutions',
  title: 'Streamlining Legal Operations',
  description:
    'Our tailored solution replaced manual workflows with an intuitive system that enables clients to submit information seamlessly, while generating accurate, ready-to-sign contracts in record time.',
  summary: [
    'Our tailored solution replaced manual workflows with an intuitive system that enables clients to submit information seamlessly, while generating accurate, ready-to-sign contracts in record time.',
  ],
  logo,
  ...
  testimonial: {
    author: { name: 'Richard O Shea', role: 'CEO of Diy Divorce Solutions' },
    content:
